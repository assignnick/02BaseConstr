...
class GUI extends JFrame {
    ...
    private String getBuildingInfo(Building building) {
        ...
        str.append("<html>").append(splitName[splitName.length - 1]).append("<br/>Floor amount: ").append(building.getAmountFloors()).
                append("<br/>Spaces amount: ").append(building.getAmountSpace()).append("<br/>")
                .append("Total area: ").append(building.getTotalSize()).append("</html>");
        return str.toString();
    }
    ...
    private void loadBuilding(String name) {
        ...
        Buildings.setBuildingFactory(Buildings.getFactoryFromName(name));
    ...
    private MouseListener getFloorML(Floor floor) {
        return new MouseListener() {
            ...
            public void mouseEntered(MouseEvent e) {
                floorInfoLabel.setText(getFloorInfo(floor));
            }
    ...
    private MouseListener getSpaceButtonML(Space space) {
        return new MouseListener() {
            ...
            @Override
            public void mouseEntered(MouseEvent e) {
                spaceInfo.setText(space.toString());
            }
    ...
    private String getFloorInfo(Floor floor) {
        ...
        str.append(name).append("<br/>Space amount: ").append(floor.getAmountSpaces())
                .append("<br/>Floor area: ").append(floor.getTotalSize()).append("</html>");
        return str.toString();
    }
